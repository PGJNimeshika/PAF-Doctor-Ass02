...
VALUES ('1', CURRENT_DATE(), CURTIME(), 'pending', '1'),
       ('2', CURRENT_DATE(), '20:00:00', 'pending', '2'),
       ('2', CURRENT_DATE(), '10:00:00', 'pending', '2');

INSERT INTO prescription (patient_id, pres_date, pres_time, descript, doctor_id, appoint_id)
VALUES  ('1', CURRENT_DATE(), CURTIME(), 'description 1', '1', '1'),
        ('2', CURRENT_DATE(), CURTIME(), 'description 2', '2', '2');
